...
with(house_power_consum_filter2,plot(DateTime2,Sub_metering_1,ylab="Energy sub metering",xlab="",type="l",col="black"))
...
lines(house_power_consum_filter2$DateTime2,house_power_consum_filter2$Sub_metering_3,col="blue")
